...
export const messages: Record<AppLocale, AppMessages> = {
  ko: {
    app: {
      ...
      fallbackNotice: "데이터를 불러오지 못해 샘플 데이터를 표시합니다.",
      retry: "다시 시도",
      previousMonth: "이전 달",
      nextMonth: "다음 달",
      monthInput: "기록할 월",
    ...
    auth: {
      ...
      passwordLabel: "비밀번호",
      passwordPlaceholder: "8자 이상, 72바이트 이하",
      ...
      previewBackButton: "체험 화면으로 돌아가기",
      submitBusy: "처리 중",
      ...
      signupWeakPassword: "비밀번호는 8자 이상, UTF-8 기준 72바이트 이하여야 합니다.",
    ...
    account: {
      ...
      newPasswordPlaceholder: "8자 이상, 72바이트 이하",
      ...
      passwordChangeWeakPassword:
        "새 비밀번호는 8자 이상, UTF-8 기준 72바이트 이하여야 합니다.",
  ...
  en: {
    app: {
      ...
      fallbackNotice: "Showing sample data because current data could not load.",
      retry: "Retry",
    ...
    auth: {
      ...
      passwordPlaceholder: "8+ characters, up to 72 bytes",
      ...
      previewBackButton: "Back to guest mode",
      submitBusy: "Working",
    ...
    account: {
      ...
      newPasswordPlaceholder: "8+ characters, up to 72 bytes",
      ...
      passwordChangeWeakPassword:
        "New password must be at least 8 characters and no more than 72 UTF-8 bytes.",
    ...
    controller: {
      prepareUnavailable: "Goals can only be carried forward from account data.",
      prepareSuccess: "Goals were carried forward.",
      prepareFailure: "Could not carry goals forward.",
      checkUnavailable: "Checks can only be saved to account data.",
      checkFailure: "Could not save the check.",
      memoUnavailable: "Memos can only be saved to account data.",
      ...
      editUnavailable: "Goals can only be edited in account data.",
      editFailure: "Could not update the goal.",
      editRefreshFailure: "The goal was updated, but the screen could not refresh.",
      deactivateUnavailable: "Goals can only be ended in account data.",
